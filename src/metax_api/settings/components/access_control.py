...
api_permissions.rest.contracts.create = [Role.METAX, Role.TPAS]
api_permissions.rest.contracts.read = [Role.METAX, Role.TPAS]
api_permissions.rest.contracts["update"] = [Role.METAX, Role.TPAS]
api_permissions.rest.contracts.delete = [Role.METAX, Role.TPAS]
