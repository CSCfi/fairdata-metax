...
def add_permissions(apps, schema_editor):
    ...
    for cr in CatalogRecord.objects.filter(draft_of__isnull=True).order_by(
        "dataset_version_set_id", "id"
    ):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("editor_permissions", "user_id"),
                name="unique_dataset_user_permission",
            ),
        ),
        migrations.AddConstraint(
            model_name="editoruserpermission",
            constraint=models.CheckConstraint(
                check=models.Q(_negated=True, user_id=""), name="require_user_id"
            ),
        ),
        migrations.AddConstraint(
            model_name="editoruserpermission",
            constraint=models.CheckConstraint(
                check=models.Q(role__in=["creator", "editor"]), name="require_role"
            ),
        ),
