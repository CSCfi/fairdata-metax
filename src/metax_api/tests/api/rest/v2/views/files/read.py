...
class FileApiReadGetRelatedDatasets(FileApiReadCommon):
    ...
    def test_keysonly(self):
        ...
        """
        response = self.client.post('/rest/v2/files/datasets?keysonly', [1], format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK, response.data)
        ...
        response = self.client.post('/rest/v2/files/datasets?keys=files&keysonly', [1, 2], format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK, response.data)
        ...
        response = self.client.post('/rest/v2/files/datasets?keys=datasets&keysonly', [1, 2], format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK, response.data)
