...
class StatisticRPCCountDatasets(StatisticRPCCommon, CatalogRecordApiWriteCommon):
    ...
    def test_count_datasets_single(self):
        ...
        total_count = CatalogRecord.objects_unfiltered.count()
        response = self.client.get(
            "/rpc/v2/statistics/count_datasets?latest=false"
        ).data  # returns all
    ...
    def test_count_datasets_removed_latest(self):
        ...
        rem_not_lat = self.client.get(
            "/rpc/v2/statistics/count_datasets?removed=true&latest=false"
        ).data
        ...
        not_rem_lat = self.client.get(
            "/rpc/v2/statistics/count_datasets?removed=false&latest=true"
        ).data
        not_rem_not_lat = self.client.get(
            "/rpc/v2/statistics/count_datasets?removed=false&latest=false"
        ).data
    ...
    def test_count_datasets_removed_legacy(self):
        ...
        rem_not_leg = self.client.get(
            "/rpc/v2/statistics/count_datasets?removed=true&legacy=false"
        ).data
        not_rem_leg = self.client.get(
            "/rpc/v2/statistics/count_datasets?removed=false&legacy=true"
        ).data
        not_rem_not_leg = self.client.get(
            "/rpc/v2/statistics/count_datasets?removed=false&legacy=false"
        ).data
    ...
    def test_count_datasets_latest_legacy(self):
        ...
        leg_not_lat = self.client.get(
            "/rpc/v2/statistics/count_datasets?legacy=true&latest=false"
        ).data
        not_leg_not_lat = self.client.get(
            "/rpc/v2/statistics/count_datasets?legacy=false&latest=false"
        ).data
...
class StatisticRPCforDrafts(StatisticRPCCommon, CatalogRecordApiWriteCommon):
    ...
    def test_catalog_datasets_cumulative_for_drafts(self):
        ...
        url = (
            "/rpc/v2/statistics/catalog_datasets_cumulative?from_date=2019-06-01&to_date=2019-06-30"
        )
