...
JSON schema files dataset metadata descriptions (field ``research_dataset``):
    ...
    * `IDA datasets <https://raw.githubusercontent.com/CSCfi/fairdata-metax/master/src/metax_api/api/rest/base/schemas/ida_dataset_schema.json>`_ (schema used in IDA data catalog)
    * `ATT datasets <https://raw.githubusercontent.com/CSCfi/fairdata-metax/master/src/metax_api/api/rest/base/schemas/att_dataset_schema.json>`_ (schema used in ATT data catalog)
